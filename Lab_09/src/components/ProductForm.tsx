...
const styles = {
  ...
  modal: { background: 'var(--card-bg)', borderRadius: 16, padding: 30, width: 400 },
  title: { fontSize: 24, fontWeight: 600, marginBottom: 24, textAlign: 'center' as const, color: 'var(--text-color)' },
  input: { width: '100%', padding: 12, border: '1px solid var(--border-color)', borderRadius: 10, fontSize: 16, marginBottom: 16, boxSizing: 'border-box' as const, background: 'var(--card-bg)', color: 'var(--text-color)' },
  ...
  cancel: { background: 'var(--border-color)', color: 'var(--text-color)' },
