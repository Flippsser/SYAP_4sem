...
const styles = {
  ...
  card: { background: 'white', borderRadius: 16, padding: 24, boxShadow: '0 4px 15px rgba(0,0,0,0.08)' },
  title: { fontSize: 28, fontWeight: 600, marginBottom: 16 },
  text: { fontSize: 16, color: '#555', marginBottom: 12 },
  back: { display: 'inline-block', marginBottom: 16, color: '#2c3e50', textDecoration: 'none' },
